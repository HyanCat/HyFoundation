...
#define IOS10_OR_LATER HY_SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"10")
#define IOS11_OR_LATER HY_SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"11")
...
#define IOS10_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN(@"11")
#define IOS11_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN(@"12")
...
#define IOS10 (IOS10_OR_LATER && IOS10_OR_BEFORE)
#define IOS11 (IOS11_OR_LATER && IOS11_OR_BEFORE)
